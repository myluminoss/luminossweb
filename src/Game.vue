        ...
        <div class="game_game__xLvXD">
            ...
            <div class="game_f1__cuMDo game_gamePart__PigM0">
                ...
                <div class="game_banners__uNAU2">
                    ...
                    }" @swiper="onSwiper" @slideChange="onSlideChange" @activeIndexChange="activeIndexChangeFunc"
                        :modules="[Autoplay, EffectFade]" :allowTouchMove='false' effect="fade" class="mySwiper swiper">
                        <swiper-slide class="swiper-slide" :class="item.id" v-for="(item, index) in bannerArray"
                            :key="index + 'sss'">
                            <div>
                                <div class="BannerItem_bannerItem__zaAX9" :style="{
                                    backgroundImage: 'url(' + item.img + ')'
                                }">
                                    <img src="@/assets/images/bannerMask.png" class="bannerMask" />
                                    ...
                                    <div class="BannerItem_linearBg__fwY9N">
                                        ...
                                        <div class="BannerItem_btnBox__sCN3f">
                                            <div class="BannerItem_btnGetStarted__jczJ6" @click="goodBuy">
                                                <div class="Button_button__fo9Wi Button_default__ulIdO"
                                                    style="padding: 12px 16px;">
                                                    <div class="BannerItem_oCardBtn__A1_lt"><span>Get Started</span><img
                                                            src="@/assets/images/game/icon-go.svg" alt=""></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="BannerItem_description__uBIim">{{ item.subTitle }}</div>
                    ...
                    <div class="game_smallBannerBox__8A0rb">
                        <div @click="clickSwiper(item)" v-for="(item, index) in bannerArray" :key="index"
                            class="SmallBannerItem_smallBannerItem___8kE_ "
                            :class="index == bannerCurrentIndex ? 'SmallBannerItem_smallBannerItem___8kE_active' : ''"
                            :style="{
                                backgroundImage: 'url(' + item.img + ')'
                            }">
                            <div class="SmallBannerItem_opacityBg__lWqnY "
                                :class="index == bannerCurrentIndex ? 'SmallBannerItem_opacityAnimation__srOYx' : ''">
                            </div>
                        </div>
                    </div>
