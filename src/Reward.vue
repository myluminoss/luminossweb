    ...
    <div class="rewards_content">
        <div class=" rewards_accountWrap__yZp7R">
            ...
            <div class="rewards_f1__Hhz88">
                ...
                <div v-if="myInfoObj != null" class="rewards_div1P___aVFL">
                    <div class="Info_div1P__71N42">
                        <div class="Info_div1__Plpc2  Info_jus__mv8hx Info_ane__u3h3O">
                            <div class="Info_flex__AFdiV Info_ane__u3h3O"><img :src="myInfoObj.avatar"
                                    class="Info_img3__BiJTa">
                                <div>

                                    <p class="Info_t3__sTetu Info_flex__AFdiV Info_ane__u3h3O"
                                        style="margin-top: 10px;"> {{ (myInfoObj.nickname) }}</p>
                                    <div class="Info_flex__AFdiV Info_ane__u3h3O Info_t5__uIFdO"> {{
                                        (myInfoObj.nickname) }}<div class="Tips_tipsWrapper__eu4qJ">
                            ...
                            <div class="Info_righttxt__mGELN">
                                <p class="Info_aend__0xuT52222  Info_aend__0xuT5 Info_flex__AFdiV Info_ane__u3h3O"><img
                                        src="@/assets/img/icon-points.svg" width="32" style="margin-right: 8px;">{{
                                            myInfoObj.earn }}</p>
                                ...
                                <p class="Info_t151__wvsvk Info_aend__0xuT5">Current ranking:
                                    {{ myInfoObj.currentRanking }}</p>

                            </div>
                        </div>
                    </div>
                    <ul class="rewards_ul2__rGaVC rewards_flex__1bUuD rewards_ane__ewOrF rewards_wrap__hhofu">
                        ...
                        <li v-for="(item, index) in quests" :key="index"
                            ...
                            <div style="width: 100%;">
                                <div class="rewards_flex__1bUuD222">
                                    <p class="rewards_t11__sl8sJ"><span class="rewards_s-icon__q5Dxn"><img
                                                class="rewards_discord__59JpK" src="./assets/img/a10.png"
                                                width="32"></span>
                                    </p>
                                    <div>
                                        <p class="rewards_t12__JylBZ rewards_longTitle__4G2Yk">{{
                                            item.name }}</p><span class="rewards_t13__Vm8IV">{{ item.intro }}</span>
                                    </div>
                                </div>
                                <div
                                    class="rewards_t14__dqII6 rewards_flex__1bUuD rewards_ane__ewOrF rewards_jus__ZMbtH">
                                    <div>Earn</div>
                                    <div class="rewards_flex__1bUuD rewards_ane__ewOrF"><img
                                            src="./assets/img/icon-points.svg" width="16" style="margin-right: 8px;">+{{
                                                item.earn }}</div>
                                </div>
                                <a :class="item.status == 2 ? 'Button_disabled__QUCEs' : ''" :href="item.link"
                                    @click="toFinishTask(item)" target="_blank"
                                    class="Button_button__fo9Wi Button_default__ulIdO Button_full__ATquN Button_button__aaaa">Go</a>
                        ...
                        <li>
                            <div class="Checkin_ane__IWzue Checkin_jus__ZVuyQ">
                                <div class="Checkin_flex__cQSqh">
                                    <div class="Checkin_t15img__WrZhE"><img src="@/assets/icons/a277.png" width="24">
                                    </div>
                                    <p class=""><span class="Checkin_ps1__NpZ2U">Weekly check-in</span><span
                                            class="Checkin_ps2__RmC5o">Unlock the ability to earn more crystals by
                                            creating on-chain interactions for 7 consecutive days.</span></p>
                                </div>
                            </div>
                            <div class="Checkin_checkinList__2dQX3">
                                <div class="Checkin_lidiv__ainUr"
                                    :class="item.status == 2 ? 'Checkin_active__vE_g9' : ''"
                                    v-for="(item, index) in signs">
                                    <div class="Checkin_checkinImgCont__cSk5y"><img
                                            :src="item.status == 2 ? ionPoints1 : ionPoints2" width="28"
                                            alt="Not Checked In"><span class="Checkin_ps3__S4cD4">+ {{
                                                item.earn
                                            }}</span></div>
                            ...
                            <div style="">
                                <div @click="onClickSign" :class="todaySign ? 'Button_disabled__QUCEs' : ''"
                                    class="Button_button__fo9Wi Button_default__ulIdO Button_full__ATquN">CHECK-IN
                                </div>
                            </div>
...
watch(() => walletEx.myAddress, (nv, ov) => {
    console.log(nv)
})
...
const onClickSign = async () => {
    ...
    console.log('合约中checkIn方法返回的结果:', result3);
    ...
    try {
        ...
        userEx.getUserInfo();
        userEx.getTaskList()
        console.log('合约中checkIn方法返回的结果:', signRes);
        showLoading.value = false;;
...
const copyText = () => {
    ...
    let textToCopy = myInfoObj.value.walletAddress;
