    ...
    <div class="topNav">
        <div class="Top_h__XiNVG Top_flex__z5fMG Top_ane__l1HcL Top_padr30__dW_Yj ">
                    ...
                    <div class="entity entityBase">
                        ...
                        <div class="entityMenu">
                            ...
                            <div class="entityList">
                                <div class="entityItem" @click="clickEntity(item.i)"
                                    :class="item.i == entityIndex ? 'entityItemActive' : ''"
                                    v-for="(item, index) in entityArray" :key="index">
                                    <h3>{{ item.title }}</h3>
                                    <h5>{{ item.desc }}</h5>
                                    <img v-if="item.i == entityIndex" class="check"
            ...
            <div class="Top_right__Nkxnr">
                <div v-show="myAddress != ''" class="Top_newModal__e7YBk Top_flex__z5fMG Top_ane__l1HcL">
                    <div class="Top_headerAddress__8Sup4">{{ myAddress }}</div>
                    <div class="Top_newcontent__ocWEd">
                        <div class="Top_userInfos__kYEP5">
                            <div class="Top_uAvater__64PTF"><img :src="myAvatar" class="Top_avaterIcon__DHdid">
                                <div class="Dropdown_flex__DKxTG Dropdown_ane__0tQAP Top_dropDwon__PkltW">
                                    <div class="Dropdown_newModal__Xubow Dropdown_flex__DKxTG Dropdown_ane__0tQAP">

                                        <div class="Dropdown_newContentWrap__lCQI8">
                                            <div class="Dropdown_newcontent__LtZMc">
                            ...
                            <h2 class="Top_userName__OXb2U">{{ myAddress }}</h2>
                ...
                <div v-show="myAddress == ''" @click="onClickLoginWallet" class="Top_loginBtn">
        ...
        <div class="Top_mobileHeader__Oe32f">
            <div class="Header_header__G9Trc">
                ...
                <div class="menuIcon">
                    <img class="menuImg" @click="openLeftMenu" src="@/assets/entiry/UI_Btn_Icon_05_2.png" />
                ...
                <div class="Header_blackHeader__46Gtf">
                    ...
                    <div class="Header_rightElements__6suUD">
                        <div class="Header_links__nDFIE">
                            ...
                            <a href="/Reward" data-hover="Nodes" target="_self" class="Header_nodes__HgU4L">
                                <div class="Header_nodesIcon__MQ4QV"></div>
                            </a>
                            <!-- <a href="https://docs.luminoss.ai/" data-hover="Docs" target="_blank" class="">Docs</a> -->

                            <div>App<img src="@/assets/images/icon/chevron-down.svg">
                                <div class="Header_dropdown__C0CBu"><a href="/" class="">
                                        <div class="Header_dropdownDot__W66y8"></div>Discover
                                    </a><a href="/rewards" class="Header_currentRoute__5C8CB">
                                        <div class="Header_dropdownDot__W66y8"></div>Rewards
                                    </a><a href="/account" class="">
                                        <div class="Header_dropdownDot__W66y8"></div>Account
                                    </a></div>
                            </div>
                        </div>

                        <div v-show="myAddress == ''" @click="onClickLoginWallet"
                        ...
                        <div class="Header_connectContainer__2VGQF Header_open__tcN4y">
                            <div class="Header_newModal__lIrQv">
                                <div v-show="myAddress != ''" @click="showInfoPopup"
                                    class="Header_headerAddress__g_fc2">{{ myAddress }}</div>
                                <div class="Header_newcontent__2N_p7 " ref="dialogRef" :class="showPopupClass">
                                    <div class="Header_userInfos__VhQnj">
                                        <div class="Header_uAvater__2kGpY"><img :src="myAvatar"
                                                class="Header_avaterIcon__AGCi4">
                                            <div
                                    ...
                                    <div class="Header_logout__hI53P" @click="showConfirm = true"><img
                                            src="@/assets/img/icon-logout.svg"><span>Disconnect</span></div>
                                </div>
                            </div>
                            <div @click="openMenu" class="Header_menuWrap__xypxI "
                                :class="isOpen ? 'Header_open__tcN4y' : ''">
                                <div class="Header_menu__pRYvp " :class="isOpen ? 'Header_open__tcN4y' : ''">
                                    <span></span><span></span><span></span><span></span>
                                </div>
                            </div>
                            <div class="Header_mobileMenu__XO2xB " :class="isOpen ? 'Header_open__tcN4y' : ''">
                                <div class="Header_menuItems__RT2HN">
                                    <a href="/" data-hover="Home" target="_self" class="">Discover</a>
                                    <a href="/Reward" data-hover="Reward" target="_self" class="">Reward</a>
                                    <a href="/account" data-hover="Account" target="_self" class="">Account</a>



                                </div>
                                <div class="Header_socialIcons__J4VZi" v-if="false">
                                    <div><img src="@/assets/images/icon/x.svg">
                                        <div class="Header_mobileMenuItems___VHHM"><a href="https://x.com/BalanceWeb3"
                                                target="_blank" class=""><img
                                                    src="@/assets/images/icon/x-menu.svg">Balance Intern</a><a
                                                href="https://x.com/RealBalanceFun" target="_blank" class=""><img
                                                    src="@/assets/images/icon/x-menu.svg">Balance Community</a></div>
                                    </div><a href="https://discord.com/invite/balance-fun" target="_blank"><img
                                            src="@/assets/images/icon/discord.svg"></a>
                                    <div><img src="@/assets/images/icon/telegram-circle.svg">
                                        <div class="Header_mobileMenuItems___VHHM"><a
                                                href="https://t.me/Balancefun_announcement" target="_blank"
                                                class=""><img
                                                    src="@/assets/images/icon/telegram-circle-menu.svg">Telegram
                                                Announcement</a><a href="https://t.me/Balance_Fun" target="_blank"
                                                class=""><img
                                                    src="@/assets/images/icon/telegram-circle-menu.svg">Telegram
                                                Community</a></div>
                                    </div>
        ...
        <div class="react-confirm-alert-overlay undefined" v-show="showConfirm">
            <div class="react-confirm-alert">
                <div class="Top_react-confirm-alert-body__9JCTC">
                    <p class="Top_react-confirm-header__GdcTP">Sure you want to log out?</p>
                    <div style="margin-top: 18px;">
                        <button class="Top_react-confirm-cancel__TB5z2" @click="showConfirm = false">No</button>
                        <button @click="loginOutFunc" class="Top_react-confirm-confirm__Lc_H_">Yes</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="react-confirm-alert-overlay undefined" v-show="notWallet">
            <div class="react-confirm-alert">
                <div class="Top_react-confirm-alert-body__9JCTC">
                    <p class="Top_react-confirm-header__GdcTP">Please install the Solflare Wallet or Trust Wallet plugin
                        to Log in.</p>
                    <div style="margin-top: 18px;">
                        <button @click="notWallet = false" class="Top_react-confirm-confirm__Lc_H_">OK</button>
                    </div>
                </div>
            </div>
        </div>
...
const updateUserInfo = () => {
    ...
    myAvatar.value = userEx.userInfo.avatar;
}
